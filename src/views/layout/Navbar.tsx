          ...
          <div className="flex items-center gap-4 flex-1 max-w-[800px]">
            ...
            <div className="relative" ref={dropdownRef}>
              <button 
                ...
                className="flex items-center gap-2 text-[#222222] text-sm font-medium hover:text-primary transition-colors whitespace-nowrap"
              >
                <MapPin className="h-4 w-4" />
              ...
              <AnimatePresence>
                {isCityDropdownOpen && (
                  <motion.div
                    ...
                    className="absolute top-full right-0 mt-4 w-48 bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-gray-100 py-2 z-50 overflow-hidden"
                  >
