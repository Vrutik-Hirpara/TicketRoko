    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container-max py-8 mx-auto px-4">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Events you have attended</p>
        </div>
        ...
        {pastEventsError && !pastEventsLoading && (
          <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl border border-red-100 text-red-600">
            <AlertCircle className="w-5 h-5 shrink-0" />
            <p className="text-sm">{pastEventsError}</p>
          </div>
        )}

        {!pastEventsLoading && !pastEventsError && pastEvents.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <History className="w-14 h-14 text-gray-200 mb-4" />
            <h3 className="text-lg font-semibold text-gray-700">No past events</h3>
            <p className="text-gray-400 text-sm mt-1 mb-6">Events you have attended will appear here</p>
